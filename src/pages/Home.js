  ...
  return (
    <div className="bg-nav flex flex-col">
      <img
        ...
        alt=""
      />
      <h1 className="text-center mb-10 text-white font-jonota lg:text-3xl text-2xl">
        বিসমিল্লাহির রহমানির রহীম
      </h1>
      <div className="flex lg:justify-center flex-col lg:flex-row self-center items-center lg:gap-56 gap-10 mb-20">
